...
function App () {
  ...
  useEffect(() => {
    ...
    //when new message arrives, we will call fetchMessages function
    //to update the UI with the new messages
...
return (
  <div style={container}>
    <h1 style = {heading}> Real Time Message Board 
    </h1>
    <Input
    onChange = {onChange}
    name = 'title'
    placehodler = 'Message title'
